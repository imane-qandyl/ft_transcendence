...
//         <div className="text-pixel-white text-sm mb-1">PROFILE PICTURE</div>
//         {userData?.avatar_url && (
//           <img
...
//           </button>
//           {uploadError && (
//             <div className="text-retro-red text-xs" style={{ marginTop: 4 }}>
//               {uploadError}
//             </div>
//           )}
//         </form>
...
//           icon="*"
//           label="ELO"
//           value={character?.elo_rating}
//           color="text-retro-yellow"
//         />
//         <StatCard
//           icon="+"
//           label="WINS"
//           value={character?.wins}
...
//           <MiniStat 
//             label="TOTAL WIN GAMES" 
//             value={((character?.wins || 0))} 
//           />
//           {/* check this okay */}
//           <MiniStat 
//             label="DRAWS" 
...
//           <MiniStat 
//             label="BEST STREAK" 
//             value={longestWinStreak || 0} 
//           />
//           <MiniStat 
//             label="POINTS SCORED" 
//             value={character?.stat_points || 0} 
//           />
//           <MiniStat 
//             label="POINTS LOST" 
//             value={character?.losses || 0} 
//           />
//         </div>
//       </div>
